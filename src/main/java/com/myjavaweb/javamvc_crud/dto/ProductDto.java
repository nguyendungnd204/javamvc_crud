...
public class ProductDto {
    ...
    @NotEmpty(message = "The name is requied")
    private String name;
    ...
    public @NotEmpty(message = "The name is requied") String getName() {
        return name;
    }

    public void setName(@NotEmpty(message = "The name is requied") String name) {
        this.name = name;
    }
